...
{% if stress_test_opensourceai_submit_job_enable %}
    @task({{ test_api_list.opensourceai_submit_job.weight }})
    def submit_job(self):
        ...
        self.client.post(
            ...
            headers=opensourceai_headers,
            data=template_data
        )
{% endif %}

{% if stress_test_opensourceai_list_job_all_enable %}
    @task({{ test_api_list.opensourceai_list_job_all.weight }})
