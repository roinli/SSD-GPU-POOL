"""this is the setup (install) script for opensourceai notebook extension
"""
import os
import sys
...
if __name__ == '__main__':
    ...
    run(
        jupyter_cmd + ['nbextension', 'install', 'opensourceai_submitter'],
        '==== install opensourceai_submitter ===='
    )
    run(
        jupyter_cmd + ['nbextension', 'enable', 'opensourceai_submitter/main'],
        '==== enable opensourceai_submitter ===='
    )
